...
Route::get('chats/login/{room}', 'ChatPostsController@loginView')->name('chats.loginView');
Route::post('chats/login/{room}', 'ChatPostsController@loginStore')->name('chats.loginStore');
